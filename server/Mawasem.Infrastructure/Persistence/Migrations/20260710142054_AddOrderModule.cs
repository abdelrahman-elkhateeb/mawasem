        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsFreeDelivery = table.Column<bool>(type: "bit", nullable: false, defaultValue: false),
                    IsActive = table.Column<bool>(type: "bit", nullable: false, defaultValue: true),
                    CreatedOn = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    LastModifiedOn = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CustomAreaName = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    RequiresAreaReview = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    UserId = table.Column<int>(type: "int", nullable: false),
                    CustomerNameAr = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                    CustomerNameEn = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductGrades", x => new { x.ProductId, x.GradeId });
                    table.ForeignKey(
                        name: "FK_ProductGrades_Grades_GradeId",
                        column: x => x.GradeId,
                        principalTable: "Grades",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProductGrades_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RefundedQuantity = table.Column<int>(type: "int", nullable: false, defaultValue: 0),
                    CreatedOn = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    LastModifiedOn = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: true),
                    LastModifiedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_RefundRequestItems_Quantity_Positive", "[Quantity] > 0");
                    table.ForeignKey(
                        name: "FK_RefundRequestItems_OrderItems_OrderItemId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DeliveryAreas_IsActive",
                table: "DeliveryAreas",
                column: "IsActive");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RefundRequestItems_OrderItemId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RefundRequestItems_RefundRequestId_OrderItemId",
                table: "RefundRequestItems",
                columns: new[] { "RefundRequestId", "OrderItemId" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RefundRequests_ReviewedByEmployeeId",
                table: "RefundRequests",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserAddresses_DeliveryAreaId",
                table: "UserAddresses",
